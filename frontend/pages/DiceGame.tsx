...
//           />
//           <button onClick={handleRollDice} className="w-full p-2 bg-green-600 rounded" disabled={isRolling || balance === 0 ? true : false}>
...
//             </div>
//           )}
//           <button onClick={() => setShowDetails(!showDetails)} className="w-full p-2 mt-4 bg-blue-600 rounded" disabled={isRolling ? true : false}>
//             Verify
//           </button>
//           {showDetails && (
//             <div className="mt-4 text-sm break-words">
//               <div><span className="font-bold text-blue-400">Hash: </span>{hash}</div>
//               <div><span className="font-bold text-blue-400">User Seed: </span>{userSeed}</div>
//               <div><span className="font-bold text-blue-400">Server Seed: </span>{serverSeed}</div>
//             </div>
//           )}
//         </div>
